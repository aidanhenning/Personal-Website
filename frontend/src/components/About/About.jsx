...
export default function About() {
  return (
    <div id="about" className="mx-auto px-[10%] mb-[10%]">
      <h2 className="text-center text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#6366f1] to-[#a855f7] bg-clip-text text-transparent mb-6 animate-appear">
        About Me
      </h2>
      <p className="text-center text-lg text-black dark:text-white mb-2 animate-appear">
